...
public class ItemServiceImpl implements ItemService {
	...
	public ItemDto findByItemCode(String itemCode) {
		...
		return itemRepository.findItemByItemCode(itemCode).map(ItemDto::fromEntity)
...
//		// TODO Auto-generated method stub
//		return saleLigneRepository.findAllByItemId(itemID).stream()
//		        .map(SaleLigneDto::fromEntity)
...
//		// TODO Auto-generated method stub
//		return customerOrderRepository.findAllByItemId(itemID).stream()
//		        .map(CustomerOrderLigneDto::fromEntity)
//		        .collect(Collectors.toList());
//	}

//	@Override
//	public List<SupplierOrderLigneDto> findSupplierOrderLigneHistoryr(Integer itemID) {
//		// TODO Auto-generated method stub
//		return supplierOrderRepository.findAllByItemId(itemID).stream()
